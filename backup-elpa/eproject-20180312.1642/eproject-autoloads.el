...
(if (fboundp 'register-definition-prefixes) (register-definition-prefixes "eproject" '("define-" "dot-eproject-mode" "eproject-" "generic")))
...
(if (fboundp 'register-definition-prefixes) (register-definition-prefixes "eproject-perl" '("cperl-" "perl")))
...
(if (fboundp 'register-definition-prefixes) (register-definition-prefixes "eproject-tasks" '("anything-eproject-tasks" "eproject-tasks-" "helm-eproject-tasks")))
