;;; rescript-mode-autoloads.el --- automatically extracted autoloads
;;
;;; Code:
...
(if (fboundp 'register-definition-prefixes) (register-definition-prefixes "rescript-indent" '("rescript-")))
...
(if (fboundp 'register-definition-prefixes) (register-definition-prefixes "rescript-mode" '("rescript-")))
