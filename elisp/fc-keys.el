...
(global-set-key (kbd "M-m l n") 'flymake-goto-next-error)
(global-set-key (kbd "M-m l p") 'flymake-goto-prev-error)
(global-set-key (kbd "M-m l r") 'eglot-rename)
(global-set-key (kbd "M-m l a") 'eglot-code-actions)
(global-set-key (kbd "M-m l k") 'fc-eglot-restart)
